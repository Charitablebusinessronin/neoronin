...
```xml
<agent id="dev.agent.yaml" name="Brooks" title="Developer Agent" icon="💻">
<activation critical="MANDATORY">
      ...
      <step n="3">🚨 SYNAPTIC SYNC REQUIRED - Use MCP Memory Tools:
          ...
          - Call search_memories(query="Brooks identity verification", memoryTypes=["all"]) to check status
  ...
  <menu>
    ...
    <item cmd="DS or fuzzy match on dev-story" workflow="./_bmad/bmm/workflows/4-implementation/dev-story/workflow.yaml">[DS] Execute Dev Story workflow (full BMM path with sprint-status)</item>

...
- When 'A' selected: Execute ./_bmad/core/workflows/advanced-elicitation/workflow.xml
- When 'P' selected: Execute ./_bmad/core/workflows/party-mode/workflow.md
...
- Execute ./_bmad/core/workflows/advanced-elicitation/workflow.xml with the current responsive/accessibility content
...
- Execute ./_bmad/core/workflows/party-mode/workflow.md with the current responsive/accessibility strategy

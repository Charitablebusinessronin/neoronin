...
- Execute ./_bmad/core/workflows/advanced-elicitation/workflow.xml with the current design system content
...
- Execute ./_bmad/core/workflows/party-mode/workflow.md with the current design system choice

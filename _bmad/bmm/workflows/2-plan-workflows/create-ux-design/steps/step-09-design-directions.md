...
- Execute ./_bmad/core/workflows/advanced-elicitation/workflow.xml with the current design direction content
...
- Execute ./_bmad/core/workflows/party-mode/workflow.md with the current design direction

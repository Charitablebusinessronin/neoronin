...
- Execute ./_bmad/core/workflows/advanced-elicitation/workflow.xml with the current context analysis
...
- Execute ./_bmad/core/workflows/party-mode/workflow.md with the current project context

...
workflow_path: './_bmad/bmm/workflows/bmad-quick-flow/quick-dev'
...
```xml
<invoke-task>Review {diff_output} using ./_bmad/core/tasks/review-adversarial-general.xml</invoke-task>
```

...
workflow_path: './_bmad/bmm/workflows/bmad-quick-flow/quick-spec'
...
- **[r]**: Execute Adversarial Review:
    1. **Invoke Adversarial Review Task**:
       ...
       <invoke-task>Review {finalFile} using ./_bmad/core/tasks/review-adversarial-general.xml</invoke-task>

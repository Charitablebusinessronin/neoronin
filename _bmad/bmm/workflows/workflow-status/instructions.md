...
<critical>The workflow execution engine is governed by: ./_bmad/core/tasks/workflow.xml</critical>
<critical>You MUST have already loaded and processed: ./_bmad/bmm/workflows/workflow-status/workflow.yaml</critical>
...
<check if="no status file found">
  ...
  <check if="response == y OR response == yes">
    ...
    <invoke-workflow path="./_bmad/bmm/workflows/workflow-status/init/workflow.yaml"></invoke-workflow>
